...
- A **Timeline** button turns time into depth: the genre's origins sit right at your nose and the future recedes into the dark. Pull or scroll to fly through the artists — each star anchored at its debut record, era strands wrapping the tunnel, careers streaming past as light-trails dotted with their essential records, decade gates ringing by, faces resolving as they approach. A flick keeps you coasting; the year readout is your instrument panel; the Tight–Spread slider stretches time itself, to unbunch the crowded years when creativity ran hot (1945, 1988…). Toggle again to fold the voyage back into the globe.
